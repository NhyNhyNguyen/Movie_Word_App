...
class _ChooseProfile extends State<ChooseProfile> {
  String type = "profile";
  String imageUrl = UrlConstant.IMAGE + "98307201_314497226215952_6080107368102756352_n-30987288442578.jpg";
  Widget _editBtn() {
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    image:  DecorationImage(
                                        image: /*ConstantVar.userDetail.avt == null ? AssetImage(ImageConstant.LOGO):*/ NetworkImage("http://10.0.2.2:9000/api/image/${ConstantVar.userDetail.avt}"),
                                        fit: BoxFit.cover,),
                                  ),
                                ),
                                Text(
